...
docker run -d --name voting -p 8080:8080 --link postgres:postgres --link zookeeper:zookeeper --link my-cluster-kafka-bootstrap:my-cluster-kafka-bootstrap quay.io/bridlos/voting-service-quarkus
